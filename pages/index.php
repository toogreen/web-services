                  ...
                  <div class="overflow-hidden">
                    <div class="d-lg-flex align-items-center font-weight-bold ls mt-3 mt-md-5 text-uppercase" data-zanim-xs='{"delay":0.4}'>
                      ...
                      <div class="overflow-hidden">
                        ...
                        <a href="https://www.linkedin.com/in/toogreen/" target="_blank"><span class="fab fa-linkedin text-dark mr-2 fs-0"></span></a>
        ...
        <div class="container">
          ...
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-sm-8 col-lg-4 mt-4 mt-lg-0 px-lg-4">
              <img class="w-100 rounded" src="assets/img/toogreen/icloud-avatar-header-cropped.png" style="max-width: 200px;" alt="" data-zanim-xs='{"animation":"zoom-out","delay":0.1}' data-zanim-trigger="scroll" />
            </div>
